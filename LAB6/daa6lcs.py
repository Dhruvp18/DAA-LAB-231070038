...
for i in range(1, 6):
    file_path = f"./positive_test_case_{i}.csv"  # Use relative path with forward slashes
...
print("\nNegative Test Cases:")
for i in range(1, 6):
    file_path = f"./negative_test_case_{i}.csv"  # Use relative path with forward slashes
    df = pd.read_csv(file_path)
